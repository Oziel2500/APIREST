...
const archivoArr = fs.readFileSync(path.join(__dirname, '/archivosyaml/objeto.yml'), 'utf8');
const valorArr = yaml.parse(archivoArr);
console.table(valorArr);

const archivoObAr = fs.readFileSync(path.join(__dirname, '/archivosyaml/objeto.yml'), 'utf8');
const valorObAr = yaml.parse(archivoObAr);
console.table(valorObAr);

const archivoArOb = fs.readFileSync(path.join(__dirname, '/archivosyaml/objeto.yml'), 'utf8');
